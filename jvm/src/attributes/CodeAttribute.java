...
public class CodeAttribute extends Attribute {
	...
	public String codeToString() {
		...
		int p = 0;
		CodeRunner codeRunner = new CodeRunner(code, this, null, Collections.emptyList()); 
		return codeRunner.toString();
	}

	public Object execute(JVMObject object, List<Object> args) {
		CodeRunner codeRunner = new CodeRunner(code, this, object, args); 
