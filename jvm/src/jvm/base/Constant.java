...
public abstract class Constant extends ClassPart{
	...
	public static class ClassConstant extends Constant{
		...
		public Object getValue() {
			String className = getNameConstant().toString();
			if(className.startsWith("[")) {
				return Clazz.getInstanceFor(ArrayClass.instance);
			} else {
				Class clazz = getClazz().getClassPool().getClazz(className);
				return Clazz.getInstanceFor(clazz);
			}
		}
	...
	public static class StringConstant extends Constant{
		...
		@Override
		public Object getValue() {
			return JVMObject.makeString(getConstant(string_index).toString(),getClazz());
		}
	}
	public static class UtfConstant extends Constant{
		...
		public UtfConstant(String data, Class clazz) {
			super(clazz);
			this.data = data;
		}
		@Override
		...
		@Override
		public Object getValue() {
			return JVMObject.makeString(data,getClazz());
		}
	}
	...
	public static class InvokeDynamicConstant extends Constant{
		...
		public short getBootstrapMethodIndex(){
	...
	public static class MethodHandleConstant extends Constant{
		...
		@Override
		public String toString() {
			return reference_kind + ":" + getConstant(reference_index).toString();
		}
		public byte getReferenceKind(){
			return reference_kind;
		}
		public MethodConstant getReference(){
			return (MethodConstant) getConstant(reference_index);
		}
	}
