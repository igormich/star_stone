...
public class AsmCommand {
	...
	public static AsmCommand[] commands = new AsmCommand[]{
		...
		new AsmCommand("ldc2_w", cr -> {throw new RuntimeException();},
		...
		cr.push(i2<<i1);}),
		new AsmCommand("lshl", cr -> {Long i1=(Long)cr.pop();Long i2=(Long)cr.pop(); 
		cr.push(i2<<i1);}),
		...
		new AsmCommand("if_icmpeq", cr -> {throw new RuntimeException();}),
		new AsmCommand("if_icmpne", cr -> {if(!cr.eq()) {cr.jmp(cr.getIndex2());}},cr-> {return "\t"+cr.getIndex2();}, 2),
		new AsmCommand("if_icmplt", cr -> {throw new RuntimeException();}),
		...
		new AsmCommand("if_icmple", cr -> {throw new RuntimeException();}),
		new AsmCommand("if_acmpeq", cr -> {throw new RuntimeException();}),
		new AsmCommand("if_acmpne", cr -> {throw new RuntimeException();}),
		...
		new AsmCommand("putfield", cr -> {cr.setField(cr.getConstant2());},
				cr-> {return "\t"+cr.getIndex2() + "\t"+cr.getConstant2P();}, 2),
		new AsmCommand("invokevirtual", cr -> {throw new RuntimeException();},
				cr-> {return "\t"+cr.getIndex2() + "\t"+cr.getConstant2();}, 2),
		new AsmCommand("invokespecial", cr -> {cr.call(cr.getConstant2());},
			cr-> {return "\t"+cr.getIndex2() + "\t"+cr.getConstant2P();}, 2),
		new AsmCommand("invokestatic", cr -> {cr.callStatic(cr.getConstant2());},
				cr-> {return "\t"+cr.getIndex2() + "\t"+cr.getConstant2P();}, 2),
		new AsmCommand("invokeinterface", cr -> {throw new RuntimeException();},
				cr-> {return "\t"+cr.getIndex2() + "\t"+cr.getConstant2P()+ "\t"+cr.getIndex1(3);}, 2),
		new AsmCommand("invokedynamic", cr -> {throw new RuntimeException();},
				cr-> {return "\t"+cr.getIndex2() + "\t"+cr.getConstant2P();}, 3),
		new AsmCommand("new", cr -> {cr.newInstance(cr.getConstant2());},
				cr-> {return "\t"+cr.getIndex2() + "\t"+cr.getConstant2P();}, 2),
		new AsmCommand("newarray", cr -> {cr.push(new ArrayList<Object>(Collections.nCopies((int) cr.pop(), null)));},
				cr-> {return "\t"+cr.getIndex1();}, 1),
		new AsmCommand("anewarray", cr -> {cr.push(new ArrayList<Object>(Collections.nCopies((int) cr.pop(), null)));},
				cr-> {return "\t"+cr.getConstant2P();}, 2),
		new AsmCommand("arraylength", cr -> {throw new RuntimeException();}),
		new AsmCommand("athrow", cr -> {throw new RuntimeException();}),
		new AsmCommand("checkcast", cr -> {throw new RuntimeException();}),
		...
		new AsmCommand("ifnull", cr -> {throw new RuntimeException();}),
		new AsmCommand("ifnonnull", cr -> {throw new RuntimeException();}),
